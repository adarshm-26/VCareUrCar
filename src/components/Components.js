...
export { CheckMailVerification } from './CheckMailVerification';
export { AddCar } from './AddCar';
export { CarDetailsModel } from './CarDetailsModel';
export { Reports } from './Reports';
export { Contact } from './Contact';
export { Terms } from './Terms';
export { Privacy } from './Privacy';
export { About } from './About';
export { ServicePage } from './ServicesList';
...
export const profileIcon = <svg width="100%" height="100%" viewBox="0 0 16 16" className="bi bi-person-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
